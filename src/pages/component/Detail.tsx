    ...
    return (
        <div className="relative flex flex-col w-full">
            ...
            <div className="hidden sm:block absolute top-[87px] left-1/2 transform -translate-x-1/2 -translate-y-0 text-center z-10 w-full px-4">
                <h2 className="font-normal text-center text-[55px] md:text-[76px] xl:text-[96px] text-white leading-[100%] mb-[26px] md:mb-[26px] lg:mb-[3px]">
                    HOW DOES IT WORK?
                </h2>
            ...
            <div className="flex flex-col sm:flex-row w-full sm:mt-0">
                ...
                <div className="relative w-full sm:w-1/3">
                    <div className="h-[373px] sm:h-[678px] md:h-[772px]">
                        <img
                            src={Turfloweb1}
                            alt="Turflo Web 1"
                    ...
                    <div className="absolute top-[371px] md:top-[365px] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <div className="bg-[#FF7018] rounded-full w-[100px] md:w-[120px] h-[100px] md:h-[120px] flex items-center justify-center">
                            <img src={Vector} className="w-1/2 h-1/2" />
                        </div>
                    </div>
                    <div className="absolute top-[440px] md:top-[440px] left-0 w-full text-center">
                ...
                <div className="relative w-full sm:w-1/3">
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-[67px] bg-[#FF7018] items-center justify-center sm:flex hidden">
                        <p className="font-normal text-[36px] lg:text-[40px] xl:text-[45px] text-center text-[#1E293B]">PLAY WITH TURFLO!</p>
                    </div>
                </div>
            </div>
