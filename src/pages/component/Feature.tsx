  ...
  return (
    <div className="bg-[#1C1C1C] text-[#FFFFFF] px-4 py-[70px] md:py-[110px] lg:py-[90px]">
      <div className="container mx-auto text-center">
        <h2 className="text-[28px] md:text-[30px] lg:text-[32px] xl:text-[36px] font-bold leading-[120%] pb-[15px] lg:pb-[45px]">
          We help you build your own sports community.
        </h2>
        <p className="text-[14px] md:text-[16px] lg:text-[16px] font-normal leading-[175%] max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-[15px] md:gap-[50px] lg:gap-[100px] xl:gap-[150px] pt-[78px] md:pt-[118px] lg:pt-[108px]">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-[60px] md:text-[70px] lg:text-[80px] xl:text-[90px] font-semibold mt-[12px] md:mt-[16px] lg:mt-[20px] xl:mt-[22px]">
              1K+
            </div>
            <div className="text-[16px] md:text-[21px] lg:text-[21px] font-semibold">Game Hosted</div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-[16px] md:text-[21px] lg:text-[21px] font-semibold">Players</div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-[16px] md:text-[21px] lg:text-[21px] font-semibold">Communities</div>
          </div>
